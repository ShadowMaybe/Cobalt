...
void COBALT_API cobalt_glBlendFunc(GLenum sfactor, GLenum dfactor) {
    ...
    if(g_cobalt.shaderblend) {
        ...
        if ((g_cobalt.blendhack) && (sfactor==GL_SRC_ALPHA) && (dfactor==GL_ONE)) {
