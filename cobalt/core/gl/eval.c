...
void COBALT_API cobalt_glMap1d(GLenum target, GLdouble u1, GLdouble u2,
...
void COBALT_API cobalt_glMap1f(GLenum target, GLfloat u1, GLfloat u2,
...
void COBALT_API cobalt_glMap2d(GLenum target, GLdouble u1, GLdouble u2,
...
void COBALT_API cobalt_glMap2f(GLenum target, GLfloat u1, GLfloat u2,
...
void COBALT_API cobalt_glMapGrid2f(GLint un, GLfloat u1, GLfloat u2,
...
void COBALT_API cobalt_glEvalPoint1(GLint i) {
    cobalt_glEvalCoord1f(glstate->map_grid[0]._1 + glstate->map_grid[0].d*i);
}

void COBALT_API cobalt_glEvalPoint2(GLint i, GLint j) {
    cobalt_glEvalCoord2f(glstate->map_grid[0]._1 + glstate->map_grid[0].d*i, glstate->map_grid[1]._1 + glstate->map_grid[1].d*j);
}

#define GL_GET_MAP(t, type)                                        \
void COBALT_API cobalt_glGetMap##t##v(GLenum target, GLenum query, type *v) { \
    noerrorShim();                                                 \
