#ifndef __COBALT_LOADER_H_
#define __COBALT_LOADER_H_
...
extern void* (COBALT_API *gles_getProcAddress)(const char *name);
extern void (COBALT_API *cobalt_getMainFBSize)(GLint* width, GLint* height);
