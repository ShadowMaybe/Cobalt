...
void freeOldProgram(oldprogram_t* old)
{
    ...
    if(old->string)
        free(old->string);
    if(old->shader)
        cobalt_glDeleteShader(old->shader->id);
...
/*
void COBALT_API cobalt_glVertexAttrib1sARB(GLuint index, GLshort x)
void COBALT_API cobalt_glVertexAttrib1fARB(GLuint index, GLfloat x);
void COBALT_API cobalt_glVertexAttrib1dARB(GLuint index, GLdouble x);
void COBALT_API cobalt_glVertexAttrib2sARB(GLuint index, GLshort x, GLshort y);
void COBALT_API cobalt_glVertexAttrib2fARB(GLuint index, GLfloat x, GLfloat y);
void COBALT_API cobalt_glVertexAttrib2dARB(GLuint index, GLdouble x, GLdouble y);
void COBALT_API cobalt_glVertexAttrib3sARB(GLuint index, GLshort x, GLshort y, GLshort z);
void COBALT_API cobalt_glVertexAttrib3fARB(GLuint index, GLfloat x, GLfloat y, GLfloat z);
void COBALT_API cobalt_glVertexAttrib3dARB(GLuint index, GLdouble x, GLdouble y, GLdouble z);
void COBALT_API cobalt_glVertexAttrib4sARB(GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
void COBALT_API cobalt_glVertexAttrib4fARB(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
void COBALT_API cobalt_glVertexAttrib4dARB(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
void COBALT_API cobalt_glVertexAttrib4NubARB(GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
void COBALT_API cobalt_glVertexAttrib1svARB(GLuint index, const GLshort *v);
void COBALT_API cobalt_glVertexAttrib1fvARB(GLuint index, const GLfloat *v);
void COBALT_API cobalt_glVertexAttrib1dvARB(GLuint index, const GLdouble *v);
void COBALT_API cobalt_glVertexAttrib2svARB(GLuint index, const GLshort *v);
void COBALT_API cobalt_glVertexAttrib2fvARB(GLuint index, const GLfloat *v);
void COBALT_API cobalt_glVertexAttrib2dvARB(GLuint index, const GLdouble *v);
void COBALT_API cobalt_glVertexAttrib3svARB(GLuint index, const GLshort *v);
void COBALT_API cobalt_glVertexAttrib3fvARB(GLuint index, const GLfloat *v);
void COBALT_API cobalt_glVertexAttrib3dvARB(GLuint index, const GLdouble *v);
void COBALT_API cobalt_glVertexAttrib4bvARB(GLuint index, const GLbyte *v);
void COBALT_API cobalt_glVertexAttrib4svARB(GLuint index, const GLshort *v);
void COBALT_API cobalt_glVertexAttrib4ivARB(GLuint index, const GLint *v);
void COBALT_API cobalt_glVertexAttrib4ubvARB(GLuint index, const GLubyte *v);
void COBALT_API cobalt_glVertexAttrib4usvARB(GLuint index, const GLushort *v);
void COBALT_API cobalt_glVertexAttrib4uivARB(GLuint index, const GLuint *v);
void COBALT_API cobalt_glVertexAttrib4fvARB(GLuint index, const GLfloat *v);
void COBALT_API cobalt_glVertexAttrib4dvARB(GLuint index, const GLdouble *v);
void COBALT_API cobalt_glVertexAttrib4NbvARB(GLuint index, const GLbyte *v);
void COBALT_API cobalt_glVertexAttrib4NsvARB(GLuint index, const GLshort *v);
void COBALT_API cobalt_glVertexAttrib4NivARB(GLuint index, const GLint *v);
void COBALT_API cobalt_glVertexAttrib4NubvARB(GLuint index, const GLubyte *v);
void COBALT_API cobalt_glVertexAttrib4NusvARB(GLuint index, const GLushort *v);
void COBALT_API cobalt_glVertexAttrib4NuivARB(GLuint index, const GLuint *v);
void COBALT_API cobalt_glVertexAttribPointerARB(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer);
void COBALT_API cobalt_glEnableVertexAttribArrayARB(GLuint index);
void COBALT_API cobalt_glDisableVertexAttribArrayARB(GLuint index);
*/

void COBALT_API cobalt_glProgramStringARB(GLenum target, GLenum format, GLsizei len, const GLvoid *string) {
    ...
    // Convert to GLSL
    const GLchar * p[1] = {0};
    p[0] = cobalt_convertARB(old->string, vertex, &glstate->glsl->error_msg, &glstate->glsl->error_ptr);
    if((!p[0]) || (glstate->glsl->error_ptr!=-1)) {
        DBG(printf("Error with ARB->GLSL conversion\nsource is:\n%s\n======\n", old->shader->source);)
        errorShim(GL_INVALID_OPERATION);
        return;
    }
    cobalt_glShaderSource(old->shader->id, 1, p , NULL);
    ...
    cobalt_glCompileShader(old->shader->id);
    GLint res = 0;
    cobalt_glGetShaderiv(old->shader->id, GL_COMPILE_STATUS, &res);
    if(res!=GL_TRUE) {
...
void COBALT_API cobalt_glBindProgramARB(GLenum target, GLuint program) {
        ...
        case GL_VERTEX_PROGRAM_ARB:
            if(program) {
                ...
                if(!old->type) {
                    ...
                    old->type = target;
                    GLuint shader = cobalt_glCreateShader(GL_VERTEX_SHADER);
        ...
        case GL_FRAGMENT_PROGRAM_ARB:
            if(program) {
                ...
                if(!old->type) {
                    // create an empty shader
                    old->type = target;
                    GLuint shader = cobalt_glCreateShader(GL_FRAGMENT_SHADER);
                    shader_t *glshader = NULL;
                    khash_t(shaderlist) *shaders = glstate->glsl->shaders;
                    k = kh_get(shaderlist, shaders, shader);
                    glshader = kh_value(shaders, k);
...
void COBALT_API cobalt_glDeleteProgramsARB(GLsizei n, const GLuint *programs) {
...
void COBALT_API cobalt_glGenProgramsARB(GLsizei n, GLuint *programs) {
...
void COBALT_API cobalt_glProgramEnvParameter4dARB(GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w) {
...
void COBALT_API cobalt_glProgramEnvParameter4dvARB(GLenum target, GLuint index, const GLdouble *params) {
...
void COBALT_API cobalt_glProgramEnvParameter4fARB(GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
...
void COBALT_API cobalt_glProgramEnvParameter4fvARB(GLenum target, GLuint index, const GLfloat *params)  {
...
void COBALT_API cobalt_glProgramLocalParameter4dARB(GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w) {
...
void COBALT_API cobalt_glProgramLocalParameter4dvARB(GLenum target, GLuint index, const GLdouble *params) {
...
void COBALT_API cobalt_glProgramLocalParameter4fARB(GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
...
void COBALT_API cobalt_glProgramLocalParameter4fvARB(GLenum target, GLuint index, const GLfloat *params) {
...
void COBALT_API cobalt_glGetProgramEnvParameterdvARB(GLenum target, GLuint index, GLdouble *params)  {
...
void COBALT_API cobalt_glGetProgramEnvParameterfvARB(GLenum target, GLuint index, GLfloat *params) {
...
void COBALT_API cobalt_glGetProgramLocalParameterdvARB(GLenum target, GLuint index, GLdouble *params) {
...
void COBALT_API cobalt_glGetProgramLocalParameterfvARB(GLenum target, GLuint index, GLfloat *params) {
...
void COBALT_API cobalt_glGetProgramivARB(GLenum target, GLenum pname, GLint *params) {
...
void COBALT_API cobalt_glGetProgramStringARB(GLenum target, GLenum pname, GLvoid *string) {
...
void COBALT_API cobalt_glGetVertexAttribdvARB(GLuint index, GLenum pname, GLdouble *params);
void COBALT_API cobalt_glGetVertexAttribfvARB(GLuint index, GLenum pname, GLfloat *params);
void COBALT_API cobalt_glGetVertexAttribivARB(GLuint index, GLenum pname, GLint *params);

void COBALT_API cobalt_glGetVertexAttribPointervARB(GLuint index, GLenum pname, GLvoid **pointer);
*/

GLboolean COBALT_API cobalt_glIsProgramARB(GLuint program) {
...
void COBALT_API cobalt_glProgramEnvParameters4fvEXT(GLenum target, GLuint index, GLsizei count, const GLfloat *params)
{
...
void COBALT_API cobalt_glProgramLocalParameters4fvEXT(GLenum target, GLuint index, GLsizei count, const GLfloat *params)
{
