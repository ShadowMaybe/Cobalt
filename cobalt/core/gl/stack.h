#ifndef __COBALT_STACK_H_
#define __COBALT_STACK_H_
...
#define COBALT_HINT_FIRST GL_SHRINK_HINT_cobalt
#define COBALT_HINT_LAST (GL_NOERROR_HINT_cobalt + 1)
...
typedef struct _glstack_t {
    ...
    GLint fog_hint;
    GLint mipmap_hint;
    GLint gles4_hint[COBALT_HINT_LAST-COBALT_HINT_FIRST];
