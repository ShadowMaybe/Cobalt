...
#ifndef COBALT_EGL_TRACE_H
#define COBALT_EGL_TRACE_H
...
//
//   adb logcat -s Cobalt:* | grep '\[EGL'
//   adb logcat -s Cobalt:* | grep '\[EGL t12345\]'   # one thread's story
//
...
// renderer into a log firehose that drops the interesting lines. Set COBALT_EGL_TRACE
// to 0 to compile all of it out.
#define COBALT_EGL_TRACE 0
