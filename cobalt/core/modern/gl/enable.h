...
#ifndef COBALT_ENABLE_H
#define COBALT_ENABLE_H
...
extern "C"
{
    ...
    enum { COBALT_MAX_CLIP_DISTANCES = 8, COBALT_MAX_DRAW_BUFFERS = 16, COBALT_MAX_VIEWPORTS = 16 };

    struct mg_enable_state_t {
        GLboolean scalar[MGC_COUNT];
        GLboolean blend_indexed[COBALT_MAX_DRAW_BUFFERS];   // GL_BLEND per draw buffer
        GLboolean scissor_indexed[COBALT_MAX_VIEWPORTS];    // GL_SCISSOR_TEST per viewport
