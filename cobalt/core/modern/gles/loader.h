// Cobalt - gles/loader.h
// Copyright (c) 2025-2026 MobileGL-Dev
// Licensed under the GNU Lesser General Public License v2.1:
//   https://www.gnu.org/licenses/old-licenses/lgpl-2.1.txt
// SPDX-License-Identifier: LGPL-2.1-only
// End of Source File Header
#ifndef COBALT_GLES_LOADER_H_
#define COBALT_GLES_LOADER_H_
...
#define NATIVE_FUNCTION_END(type, name, ...)                                                                           \
    LOG_D("Use native function: %s @ %s(...)", COBALT_RENDERER_NAME, __FUNCTION__);                                            \
...
#define STUB_FUNCTION_END(type, name, ...)                                                                             \
    LOG_W("Stub function: %s @ %s(...)", COBALT_RENDERER_NAME, __FUNCTION__);                                                  \
    return (type)1;                                                                                                    \
    }
