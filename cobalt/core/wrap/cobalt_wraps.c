...
void COBALT_API cobalt_glGetTexGendv(GLenum coord,GLenum pname,GLdouble *params) {
	GLfloat fparams[4];
	cobalt_glGetTexGenfv(coord, pname, fparams);
...
void COBALT_API cobalt_glGetMaterialiv(GLenum face, GLenum pname, GLint * params) {
	GLfloat fparams[4];
	cobalt_glGetMaterialfv(face, pname, fparams);
...
void COBALT_API cobalt_glGetLightiv(GLenum light, GLenum pname, GLint * params) {
	GLfloat fparams[4];
	cobalt_glGetLightfv(light, pname, fparams);
	int n=4;
    switch(pname) {
...
void COBALT_API cobalt_glGetTexLevelParameteriv(GLenum target, GLint level, GLenum pname, GLint *params) {
	GLfloat fparams[4];
	cobalt_glGetTexLevelParameterfv(target, level, pname, fparams);
...
void COBALT_API cobalt_glGetClipPlane(GLenum plane, GLdouble *equation) {
	GLfloat fparams[4];
	cobalt_glGetClipPlanef(plane, fparams);
	for (int i=0; i<4; i++) equation[i]=fparams[i];
}

void COBALT_API cobalt_glFrustum(GLdouble left, GLdouble right, GLdouble bottom,
             GLdouble top, GLdouble Near, GLdouble Far) {
    cobalt_glFrustumf(left, right, bottom, top, Near, Far);
}
void COBALT_API cobalt_glPixelStoref(GLenum pname, GLfloat param) {
    cobalt_glPixelStorei(pname, param);
}
void COBALT_API cobalt_glLighti(GLenum light, GLenum pname, GLint param) {
    cobalt_glLightf(light, pname, param);
}
void COBALT_API cobalt_glPixelTransferi(GLenum pname, GLint param) {
	cobalt_glPixelTransferf(pname, param);	
}
...
void COBALT_API cobalt_glLightiv(GLenum light, GLenum pname, GLint *iparams) {
    ...
    switch (pname) {
        ...
        case GL_SPECULAR:
            ...
            cobalt_glLightfv(light, pname, params);
            break;
        case GL_POSITION:
            for (int i = 0; i < 4; i++) {
                params[i] = iparams[i];
        ...
        case GL_LINEAR_ATTENUATION:
        case GL_QUADRATIC_ATTENUATION: {
            cobalt_glLightf(light, pname, *iparams);
            break;
        }
    }
}
...
void COBALT_API cobalt_glLightModeli(GLenum pname, GLint param) {
    cobalt_glLightModelf(pname, param);
}
void COBALT_API cobalt_glLightModeliv(GLenum pname, GLint *iparams) {
    switch (pname) {
        case GL_LIGHT_MODEL_AMBIENT: {
            ...
            cobalt_glLightModelfv(pname, params);
            break;
        }
        case GL_LIGHT_MODEL_LOCAL_VIEWER:
        case GL_LIGHT_MODEL_TWO_SIDE: {
            cobalt_glLightModelf(pname, *iparams);
            break;
        }
    }
}
...
void COBALT_API cobalt_glMateriali(GLenum face, GLenum pname, GLint param) {
    cobalt_glMaterialf(face, pname, param);
}
void COBALT_API cobalt_glMaterialiv(GLenum face, GLenum pname, GLint *iparams) {
    ...
    switch (pname) {
        ...
        case GL_AMBIENT_AND_DIFFUSE:
		{
            ...
            cobalt_glMaterialfv(face, pname, params);
            break;
        }
		case GL_SHININESS:
		{
            cobalt_glMaterialf(face, pname, *iparams);
            break;
        }
...
*/
void COBALT_API cobalt_glOrtho(GLdouble left, GLdouble right, GLdouble bottom,
             GLdouble top, GLdouble Near, GLdouble Far) {
    cobalt_glOrthof(left, right, bottom, top, Near, Far);
}
...
void COBALT_API glClipPlanefOES(GLenum plane, const GLfloat *equation) {
    cobalt_glClipPlanef(plane, equation);
}
void COBALT_API glDepthRangefOES(GLclampf Near, GLclampf Far) {
    cobalt_glDepthRangef(Near, Far);
}
void COBALT_API glFrustumfOES(GLfloat left, GLfloat right, GLfloat bottom,
                   GLfloat top, GLfloat Near, GLfloat Far) {
    cobalt_glFrustumf(left, right, bottom, top, Near, Far);
}
void COBALT_API glGetClipPlanefOES(GLenum pname, GLfloat equation[4]) {
    cobalt_glGetClipPlanef(pname, equation);
}
void COBALT_API glOrthofOES(GLfloat left, GLfloat right, GLfloat bottom,
                 GLfloat top, GLfloat Near, GLfloat Far) {
    cobalt_glOrthof(left, right, bottom, top, Near, Far);
}
...
#define GL_RECT(suffix, type)                                       \
    void COBALT_API cobalt_glRect##suffix(type x1, type y1, type x2, type y2) { \
        cobalt_glBegin(GL_QUADS);                                    \
        cobalt_glVertex2##suffix(x1, y1);                            \
        cobalt_glVertex2##suffix(x2, y1);                            \
        cobalt_glVertex2##suffix(x2, y2);                            \
        cobalt_glVertex2##suffix(x1, y2);                            \
		cobalt_glEnd();											    \
    }                                                               \
    void COBALT_API cobalt_glRect##suffix##v(const type *v1, const type *v2) {  \
        cobalt_glRect##suffix(v1[0], v1[1], v2[0], v2[1]);           \
    }
...
void COBALT_API cobalt_glColor3##suffix(type r, type g, type b) {             \
    cobalt_glColor4f(r*invmax, g*invmax, b*invmax, 1.0f);                   \
}                                                           \
void COBALT_API cobalt_glColor4##suffix(type r, type g, type b, type a) {     \
    cobalt_glColor4f(r*invmax, g*invmax, b*invmax, a*invmax);                  \
}                                                           \
void COBALT_API cobalt_glColor3##suffix##v(const type *v) {                   \
    cobalt_glColor4f(v[0]*invmax, v[1]*invmax, v[2]*invmax, 1.0f);          \
}                                                           \
void COBALT_API cobalt_glColor4##suffix##v(const type *v) {                   \
    cobalt_glColor4f(v[0]*invmax, v[1]*invmax, v[2]*invmax, v[3]*invmax);      \
}                                                           \
void COBALT_API cobalt_glSecondaryColor3##suffix(type r, type g, type b) {    \
    cobalt_glSecondaryColor3f(r*invmax, g*invmax, b*invmax);                \
}                                                           \
void COBALT_API cobalt_glSecondaryColor3##suffix##v(const type *v) {          \
    cobalt_glSecondaryColor3f(v[0]*invmax, v[1]*invmax, v[2]*invmax);       \
}                                                           \
/* index */                                                 \
...
void COBALT_API cobalt_glMultiTexCoord4##suffix(GLenum target, type s, type t, type r, type q) {  \
    cobalt_glMultiTexCoord4f(target, s, t, r, q);                               \
}                                                                        \
...
void COBALT_API cobalt_glRasterPos2f(GLfloat x, GLfloat y) {
    cobalt_glRasterPos3f(x, y, 0.0f);
}
void COBALT_API cobalt_glRasterPos2fv(const GLfloat *v) {
    cobalt_glRasterPos3f(v[0], v[1], 0.0f);
}
...
//    cobalt_glTexCoord4f(t[0], t[1], 0, 1);
    cobalt_glMultiTexCoord2fv(GL_TEXTURE0, t);
}
...
void COBALT_API cobalt_glTexGendv(GLenum coord, GLenum pname, const GLdouble *params) {
    ...
    if ((pname==GL_OBJECT_PLANE) || (pname==GL_EYE_PLANE))
		for (int i=1; i<4; i++)
			tmp[i]=params[i];
    cobalt_glTexGenfv(coord, pname, tmp);
}
...
// VertexArray stuff
void COBALT_API cobalt_glVertexAttrib1f (GLuint index, GLfloat v0) { GLfloat f[4] = {0,0,0,1}; f[0] =v0; cobalt_glVertexAttrib4fv(index, f); };
void COBALT_API cobalt_glVertexAttrib2f (GLuint index, GLfloat v0, GLfloat v1) { GLfloat f[4] = {0,0,0,1}; f[0] =v0; f[1]=v1; cobalt_glVertexAttrib4fv(index, f); };
void COBALT_API cobalt_glVertexAttrib3f (GLuint index, GLfloat v0, GLfloat v1, GLfloat v2) { GLfloat f[4] = {0,0,0,1}; f[0] =v0; f[1]=v1; f[2]=v2; cobalt_glVertexAttrib4fv(index, f); };
void COBALT_API cobalt_glVertexAttrib1fv (GLuint index, const GLfloat *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]; cobalt_glVertexAttrib4fv(index, f); }; \
void COBALT_API cobalt_glVertexAttrib2fv (GLuint index, const GLfloat *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]; f[1]=v[1]; cobalt_glVertexAttrib4fv(index, f); }; \
void COBALT_API cobalt_glVertexAttrib3fv (GLuint index, const GLfloat *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]; f[1]=v[1]; f[2]=v[2]; cobalt_glVertexAttrib4fv(index, f); }; \
...
void COBALT_API cobalt_glVertexAttrib1##suffix (GLuint index, type v0) { GLfloat f[4] = {0,0,0,1}; f[0] =v0; cobalt_glVertexAttrib4fv(index, f); }; \
void COBALT_API cobalt_glVertexAttrib2##suffix (GLuint index, type v0, type v1) { GLfloat f[4] = {0,0,0,1}; f[0] =v0; f[1]=v1; cobalt_glVertexAttrib4fv(index, f); }; \
void COBALT_API cobalt_glVertexAttrib3##suffix (GLuint index, type v0, type v1, type v2) { GLfloat f[4] = {0,0,0,1}; f[0] =v0; f[1]=v1; f[2]=v2; cobalt_glVertexAttrib4fv(index, f); }; \
void COBALT_API cobalt_glVertexAttrib4##suffix (GLuint index, type v0, type v1, type v2, type v3) { GLfloat f[4] = {0,0,0,1}; f[0] =v0; f[1]=v1; f[2]=v2; f[3]=v3; cobalt_glVertexAttrib4fv(index, f); }; \
void COBALT_API cobalt_glVertexAttrib1##suffix##v (GLuint index, const type *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]; cobalt_glVertexAttrib4fv(index, f); }; \
void COBALT_API cobalt_glVertexAttrib2##suffix##v (GLuint index, const type *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]; f[1]=v[1]; cobalt_glVertexAttrib4fv(index, f); }; \
void COBALT_API cobalt_glVertexAttrib3##suffix##v (GLuint index, const type *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]; f[1]=v[1]; f[2]=v[2]; cobalt_glVertexAttrib4fv(index, f); }; \
...
THUNK(d, GLdouble, _D);
#undef THUNK
void COBALT_API cobalt_glVertexAttrib4dv (GLuint index, const GLdouble *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]; f[1]=v[1]; f[2]=v[2]; f[3]=v[3]; cobalt_glVertexAttrib4fv(index, f); };
AliasExport(void,glVertexAttrib4dv,, (GLuint index, const GLdouble *v));

#define THUNK(suffix, type, norm) \
void COBALT_API cobalt_glVertexAttrib4##suffix##v (GLuint index, const type *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]; f[1]=v[1]; f[2]=v[2]; f[3]=v[3]; cobalt_glVertexAttrib4fv(index, f); }; \
AliasExport(void,glVertexAttrib4##suffix##v,, (GLuint index, const type *v)); \
void COBALT_API cobalt_glVertexAttrib4N##suffix##v (GLuint index, const type *v) { GLfloat f[4] = {0,0,0,1}; f[0] =v[0]/norm; f[1]=v[1]/norm; f[2]=v[2]/norm; f[3]=v[3]/norm; cobalt_glVertexAttrib4fv(index, f); }; \
...
#undef THUNK
void COBALT_API cobalt_glVertexAttrib4Nub(GLuint index, GLubyte v0, GLubyte v1, GLubyte v2, GLubyte v3) {GLfloat f[4] = {0,0,0,1}; f[0] =v0/255.f; f[1]=v1/255.f; f[2]=v2/255.f; f[3]=v3/255.f; cobalt_glVertexAttrib4fv(index, f); };
