...
void COBALT_API cobalt_glActiveTexture(GLenum texture) {
...
void COBALT_API cobalt_glAlphaFunc(GLenum func, GLclampf ref) {
...
void COBALT_API cobalt_glAlphaFuncx(GLenum func, GLclampx ref) {
...
void COBALT_API cobalt_glAttachShader(GLuint program, GLuint shader) {
...
void COBALT_API cobalt_glBindAttribLocation(GLuint program, GLuint index, const GLchar * name) {
...
void COBALT_API cobalt_glBindBuffer(GLenum target, GLuint buffer) {
...
void COBALT_API cobalt_glBindTexture(GLenum target, GLuint texture) {
...
void COBALT_API cobalt_glBufferData(GLenum target, GLsizeiptr size, const GLvoid * data, GLenum usage) {
...
void COBALT_API cobalt_glBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid * data) {
...
#endif
#ifndef skip_glClear
void COBALT_API cobalt_glClear(GLbitfield mask) {
...
void COBALT_API cobalt_glClearColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) {
...
void COBALT_API cobalt_glClearColorx(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha) {
...
void COBALT_API cobalt_glClearDepthx(GLclampx depth) {
...
void COBALT_API cobalt_glClientActiveTexture(GLenum texture) {
...
void COBALT_API cobalt_glClipPlanef(GLenum plane, const GLfloat * equation) {
...
void COBALT_API cobalt_glClipPlanex(GLenum plane, const GLfixed * equation) {
...
void COBALT_API cobalt_glColor4ub(GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha) {
...
void COBALT_API cobalt_glColor4x(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha) {
...
void COBALT_API cobalt_glColorMask(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha) {
...
void COBALT_API cobalt_glColorPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer) {
...
void COBALT_API cobalt_glCompressedTexImage2D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid * data) {
...
void COBALT_API cobalt_glCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid * data) {
...
void COBALT_API cobalt_glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) {
...
void COBALT_API cobalt_glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) {
...
GLuint COBALT_API cobalt_glCreateProgram() {
...
GLuint COBALT_API cobalt_glCreateShader(GLenum type) {
...
void COBALT_API cobalt_glDeleteBuffers(GLsizei n, const GLuint * buffer) {
...
void COBALT_API cobalt_glDeleteProgram(GLuint program) {
...
void COBALT_API cobalt_glDeleteTextures(GLsizei n, const GLuint * textures) {
...
void COBALT_API cobalt_glDepthRangex(GLclampx Near, GLclampx Far) {
...
void COBALT_API cobalt_glDetachShader(GLuint program, GLuint shader) {
...
void COBALT_API cobalt_glDisableClientState(GLenum array) {
...
void COBALT_API cobalt_glDrawTexf(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height) {
...
void COBALT_API cobalt_glDrawTexi(GLint x, GLint y, GLint z, GLint width, GLint height) {
...
void COBALT_API cobalt_glEnableClientState(GLenum array) {
...
void COBALT_API cobalt_glFinish() {
...
#endif
#ifndef skip_glFlush
void COBALT_API cobalt_glFlush() {
...
void COBALT_API cobalt_glFogCoordPointer(GLenum type, GLsizei stride, const GLvoid * pointer) {
...
#endif
#ifndef skip_glFogx
void COBALT_API cobalt_glFogx(GLenum pname, GLfixed param) {
...
#endif
#ifndef skip_glFogxv
void COBALT_API cobalt_glFogxv(GLenum pname, const GLfixed * params) {
...
void COBALT_API cobalt_glFrustumf(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat Near, GLfloat Far) {
...
void COBALT_API cobalt_glFrustumx(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed Near, GLfixed Far) {
...
void COBALT_API cobalt_glGenBuffers(GLsizei n, GLuint * buffer) {
...
void COBALT_API cobalt_glGenTextures(GLsizei n, GLuint * textures) {
...
void COBALT_API cobalt_glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name) {
...
void COBALT_API cobalt_glGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name) {
...
void COBALT_API cobalt_glGetAttachedShaders(GLuint program, GLsizei maxCount, GLsizei * count, GLuint * obj) {
...
GLint COBALT_API cobalt_glGetAttribLocation(GLuint program, const GLchar * name) {
...
void COBALT_API cobalt_glGetBooleanv(GLenum pname, GLboolean * params) {
...
void COBALT_API cobalt_glGetBufferParameteriv(GLenum target, GLenum pname, GLint * params) {
...
void COBALT_API cobalt_glGetClipPlanef(GLenum plane, GLfloat * equation) {
...
void COBALT_API cobalt_glGetClipPlanex(GLenum plane, GLfixed * equation) {
...
void COBALT_API cobalt_glGetFixedv(GLenum pname, GLfixed * params) {
...
void COBALT_API cobalt_glGetLightxv(GLenum light, GLenum pname, GLfixed * params) {
...
void COBALT_API cobalt_glGetMaterialfv(GLenum face, GLenum pname, GLfloat * params) {
...
void COBALT_API cobalt_glGetMaterialxv(GLenum face, GLenum pname, GLfixed * params) {
...
void COBALT_API cobalt_glGetProgramBinary(GLuint program, GLsizei bufSize, GLsizei * length, GLenum * binaryFormat, GLvoid * binary) {
...
void COBALT_API cobalt_glGetProgramInfoLog(GLuint program, GLsizei bufSize, GLsizei * length, GLchar * infoLog) {
...
void COBALT_API cobalt_glGetProgramiv(GLuint program, GLenum pname, GLint * params) {
...
void COBALT_API cobalt_glGetShaderInfoLog(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * infoLog) {
...
void COBALT_API cobalt_glGetTexEnvfv(GLenum target, GLenum pname, GLfloat * params) {
...
void COBALT_API cobalt_glGetTexEnviv(GLenum target, GLenum pname, GLint * params) {
...
void COBALT_API cobalt_glGetTexEnvxv(GLenum target, GLenum pname, GLfixed * params) {
...
void COBALT_API cobalt_glGetTexParameterfv(GLenum target, GLenum pname, GLfloat * params) {
...
void COBALT_API cobalt_glGetTexParameteriv(GLenum target, GLenum pname, GLint * params) {
...
void COBALT_API cobalt_glGetTexParameterxv(GLenum target, GLenum pname, GLfixed * params) {
...
GLint COBALT_API cobalt_glGetUniformLocation(GLuint program, const GLchar * name) {
...
#endif
#ifndef skip_glHint
void COBALT_API cobalt_glHint(GLenum target, GLenum mode) {
...
GLboolean COBALT_API cobalt_glIsBuffer(GLuint buffer) {
...
GLboolean COBALT_API cobalt_glIsProgram(GLuint program) {
...
GLboolean COBALT_API cobalt_glIsTexture(GLuint texture) {
...
void COBALT_API cobalt_glLightModelx(GLenum pname, GLfixed param) {
...
void COBALT_API cobalt_glLightModelxv(GLenum pname, const GLfixed * params) {
...
void COBALT_API cobalt_glLightf(GLenum light, GLenum pname, GLfloat param) {
...
void COBALT_API cobalt_glLightx(GLenum light, GLenum pname, GLfixed param) {
...
void COBALT_API cobalt_glLightxv(GLenum light, GLenum pname, const GLfixed * params) {
...
void COBALT_API cobalt_glLineWidth(GLfloat width) {
...
void COBALT_API cobalt_glLineWidthx(GLfixed width) {
...
void COBALT_API cobalt_glLinkProgram(GLuint program) {
...
void COBALT_API cobalt_glLoadMatrixx(const GLfixed * m) {
...
void COBALT_API cobalt_glLogicOp(GLenum opcode) {
...
void COBALT_API cobalt_glMaterialx(GLenum face, GLenum pname, GLfixed param) {
...
void COBALT_API cobalt_glMaterialxv(GLenum face, GLenum pname, const GLfixed * params) {
...
void COBALT_API cobalt_glMultMatrixx(const GLfixed * m) {
...
void COBALT_API cobalt_glMultiTexCoord4x(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q) {
...
void COBALT_API cobalt_glNormal3x(GLfixed nx, GLfixed ny, GLfixed nz) {
...
void COBALT_API cobalt_glNormalPointer(GLenum type, GLsizei stride, const GLvoid * pointer) {
...
void COBALT_API cobalt_glOrthof(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat Near, GLfloat Far) {
...
void COBALT_API cobalt_glOrthox(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed Near, GLfixed Far) {
...
void COBALT_API cobalt_glPixelStorei(GLenum pname, GLint param) {
...
void COBALT_API cobalt_glPointParameterx(GLenum pname, GLfixed param) {
...
void COBALT_API cobalt_glPointParameterxv(GLenum pname, const GLfixed * params) {
...
void COBALT_API cobalt_glPointSizePointerOES(GLenum type, GLsizei stride, const GLvoid * pointer) {
...
void COBALT_API cobalt_glPointSizex(GLfixed size) {
...
void COBALT_API cobalt_glPolygonOffset(GLfloat factor, GLfloat units) {
...
void COBALT_API cobalt_glPolygonOffsetx(GLfixed factor, GLfixed units) {
...
void COBALT_API cobalt_glProgramBinary(GLuint program, GLenum binaryFormat, const GLvoid * binary, GLint length) {
...
void COBALT_API cobalt_glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid * pixels) {
...
void COBALT_API cobalt_glReleaseShaderCompiler() {
...
void COBALT_API cobalt_glRotatex(GLfixed angle, GLfixed x, GLfixed y, GLfixed z) {
...
void COBALT_API cobalt_glSampleCoverage(GLclampf value, GLboolean invert) {
...
void COBALT_API cobalt_glSampleCoveragex(GLclampx value, GLboolean invert) {
...
void COBALT_API cobalt_glScalex(GLfixed x, GLfixed y, GLfixed z) {
...
void COBALT_API cobalt_glScissor(GLint x, GLint y, GLsizei width, GLsizei height) {
...
void COBALT_API cobalt_glShadeModel(GLenum mode) {
...
void COBALT_API cobalt_glShaderBinary(GLsizei n, const GLuint * shaders, GLenum binaryformat, const GLvoid * binary, GLsizei length) {
...
void COBALT_API cobalt_glTexCoordPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer) {
...
void COBALT_API cobalt_glTexEnvf(GLenum target, GLenum pname, GLfloat param) {
...
void COBALT_API cobalt_glTexEnvfv(GLenum target, GLenum pname, const GLfloat * params) {
...
void COBALT_API cobalt_glTexEnvi(GLenum target, GLenum pname, GLint param) {
...
void COBALT_API cobalt_glTexEnviv(GLenum target, GLenum pname, const GLint * params) {
...
void COBALT_API cobalt_glTexEnvx(GLenum target, GLenum pname, GLfixed param) {
...
void COBALT_API cobalt_glTexEnvxv(GLenum target, GLenum pname, const GLfixed * params) {
...
void COBALT_API cobalt_glTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid * data) {
...
void COBALT_API cobalt_glTexParameterf(GLenum target, GLenum pname, GLfloat param) {
...
void COBALT_API cobalt_glTexParameterfv(GLenum target, GLenum pname, const GLfloat * params) {
...
void COBALT_API cobalt_glTexParameteri(GLenum target, GLenum pname, GLint param) {
...
void COBALT_API cobalt_glTexParameteriv(GLenum target, GLenum pname, const GLint * params) {
...
void COBALT_API cobalt_glTexParameterx(GLenum target, GLenum pname, GLfixed param) {
...
void COBALT_API cobalt_glTexParameterxv(GLenum target, GLenum pname, const GLfixed * params) {
...
void COBALT_API cobalt_glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid * data) {
...
void COBALT_API cobalt_glTranslatex(GLfixed x, GLfixed y, GLfixed z) {
...
void COBALT_API cobalt_glUseProgram(GLuint program) {
...
void COBALT_API cobalt_glValidateProgram(GLuint program) {
...
void COBALT_API cobalt_glVertexAttrib1f(GLuint index, GLfloat x) {
...
void COBALT_API cobalt_glVertexAttrib1fv(GLuint index, const GLfloat * v) {
...
void COBALT_API cobalt_glVertexAttrib2f(GLuint index, GLfloat x, GLfloat y) {
...
void COBALT_API cobalt_glVertexAttrib2fv(GLuint index, const GLfloat * v) {
...
void COBALT_API cobalt_glVertexAttrib3f(GLuint index, GLfloat x, GLfloat y, GLfloat z) {
...
void COBALT_API cobalt_glVertexAttrib3fv(GLuint index, const GLfloat * v) {
...
void COBALT_API cobalt_glVertexAttrib4f(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
...
void COBALT_API cobalt_glVertexPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer) {
